...
internal class DefaultTermDetailComponent(
    ...
    override lateinit var uiState: StateFlow<TermDetailUiState>
    override lateinit var availablePropertiesUiState: StateFlow<TermDetailAvailablePropertiesUiState>
    ...
    override fun setLanguages(languages: List<LanguageModel>) {
